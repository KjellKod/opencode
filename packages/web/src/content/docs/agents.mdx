...
If you want to coordinate multiple subagents as a workflow, see [Orchestration](/docs/orchestration).
...
For practical multi-agent workflow patterns (fan-out/fan-in and iteration loops), see [Orchestration](/docs/orchestration).
